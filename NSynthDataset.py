...
class NSynthDataset(Dataset):
    ...
    def __init__(self, data_path='data/', stage='train', mel=False, sampling_rate=16000, duration=3, limit=False, min_class_count=1000, max_class_count=2000, cond_classes=None):
    ...
    def _preprocess_dataset(self):
        ...
        #annot['instrument_class'] = torch.tensor(enc.fit_transform(annot['instrument_class_str']))
